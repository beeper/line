...
- [x] Messages
  ...
  - [x] Mentions
- [x] Read receipts
- [x] Reaction support (Receive Fully supported, send Limited to ~120 emojis. See [reaction.go](https://github.com/beeper/matrix-line-messenger/blob/main/pkg/connector/reaction.go))
- [x] Replies
